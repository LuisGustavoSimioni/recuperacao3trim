...
function InscreverEstudante(){
    ...
    let idadeDoEstudanteClasseA = 0;
    let idadeDoEstudanteClasseB = 0;
     idadeDoEstudanteClasseA >= 16, 17; ("o estudante esta na classe A")
     idadeDoEstudanteClasseB >= 14, 15; ("o estudante esta na classe B")
